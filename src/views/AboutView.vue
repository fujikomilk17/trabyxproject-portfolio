      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.pinimg.com/564x/83/b9/0a/83b90a8bca57c22717743ec0cc3db726.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everybody! My name is Vigi Riyan Tanu. I am a web developer from Jombang, East Java. I        
            have 1 year experience in back-end web development and 4 years in game hacking Development.
            I really enjoy what I'm doing now, in my opinion making a program is not just a job, but also an art that
            has
            has high value
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My job is to build your App to be functional and user-friendly yet still attractive.
