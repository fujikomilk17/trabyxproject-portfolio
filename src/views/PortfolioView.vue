      ...
      items: [
        {
          ...
          github: 'https://github.com/fujikomilk17/Portofolio-v2',
        ...
        },
        {
          ...
          tech: 'VueJS 3, Tailwind',
          github: 'https://github.com/fujikomilk17/muslim-companion',
...
<template>
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-amber-50 mx-3">
    <article data-page="about">
      ...
      <section>
        <div>
          <div class="grid grid-cols-1 gap-4 pb-32 md:grid-cols-3 md:gap-3 xl:grid-cols-3 xl:gap-3 2xl:gap-5 2xl:gap-6 fade-zoom-in">
